...
<head>
    ...
    <title>Tadka Veg Food</title>
    <link rel="stylesheet" href="veg1.css">
</head>
<body>
    <header>
        <h1>Tadka Veg Food</h1>
        <p>Order your favorite vegetarian meals online!</p>
    </header>
    ...
    <footer>
        <p>Thank you for choosing our vegetarian meals!</p>
    </footer>
</body>
</html>
