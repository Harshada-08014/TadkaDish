...
<head>
    ...
    <title>Manage Desserts Food</title>
    <link rel="stylesheet" href="manage-dessert.css">
    <script>
...
<body>
    <header>
        <h1>Manage Dessrts Menu</h1>
        <!-- Redirect to add-nonveg.php when clicked -->
        <a href="add-desserts.php" class="add-item-btn">Add Item</a> <!-- Add Item button -->
    </header>
                ...
                echo "
                    <div class='menu-item'>
                        ...
                        <form method='POST' action='' onsubmit='return confirmDelete();'>
                            ...
                            <!-- Edit button -->
                            <a href='edit-desserts.php?name={$item['name']}&price={$item['price']}&image={$item['image']}' class='order-btn'>Edit</a>
