...
<head>
    ...
    <title>Manage Veg Food</title>
    <link rel="stylesheet" href="manage-veg.css">
    <script>
...
<body>
    <header>
        <h1>Manage Veg Menu</h1>
        <a href="add-item.php" class="add-item-btn">Add Item</a> <!-- Add Item button -->
    </header>
                ...
                echo "
                    <div class='menu-item'>
                        ...
                        <form method='POST' action='' onsubmit='return confirmDelete();'>
                            ...
                            <!-- Edit button -->
                            <a href='edit-food.php?name={$item['name']}&price={$item['price']}&image={$item['image']}' class='order-btn'>Edit</a>
