    ...
    <div class="menu">
        ...
        if (isset($_GET['name'], $_GET['price'], $_GET['image'])) {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                // Redirect back to manage-veg.php
                header('Location: manage-veg.php');
                exit;
            }
        } else {
        ...
        <form method="POST">
            ...
            <input type="text" id="item_name" name="item_name" value="<?php echo $name; ?>" required><br>

            <label for="item_price">Price (in INR):</label>
            <input type="number" id="item_price" name="item_price" value="<?php echo $price; ?>" required><br>

            <label for="item_image">Food Item Image URL:</label>
            <input type="text" id="item_image" name="item_image" value="<?php echo $image; ?>" required><br>
