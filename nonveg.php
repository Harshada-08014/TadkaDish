...
<head>
    ...
    <title>Tadka Non-Veg Food</title>
    <link rel="stylesheet" href="nonveg1.css">
</head>
<body>
    <header>
        <h1>Tadka Non-Veg Food</h1>
        <p>Order your favorite non-veg meals online!</p>
    </header>
    ...
    <footer>
        <p>Thank you for choosing our non-veg meals!</p>
    </footer>
</body>
</html>
